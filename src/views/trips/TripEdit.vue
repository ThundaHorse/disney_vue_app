<template>
  <div class="trip-edit">
    ...
    <div class="container">
      <!-- Date/Time/Buttons -->
      <div class="row">
        <div class="col-6">Arrival Day</div>
        <div class="col-6">Departure Day</div>
      </div>
      <br />
      <div class="row">
      ...
      <fg-input
        ...
        v-model="inputWait"
        type="integer"
        v-bind:placeholder="trip.max_wait_time"
      ></fg-input>
      <p>In total minutes</p>
      <br />
      <button class="btn btn-lg btn-round btn-success" v-on:click="submit()">Update</button> •
      <router-link v-bind:to="'/trips/add/' + trip.id">
        <button class="btn btn-round btn-raised btn-lg btn-outline-dark btn-info">Add Attractions</button>
      </router-link>
      <br />
      <br />
            ...
            <div v-if="interest.trip_id === trip.id">
              ...
              >
                ...
                <template slot="footer">
                  <slot name="footer">
                    <button
                      class="btn btn-round btn-raised btn-outline-light btn-sm btn-danger"
                      v-on:click.prevent="remove(interest)"
